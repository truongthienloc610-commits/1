...
export function AppLayout({ children }: AppLayoutProps) {
  ...
  useEffect(() => {
    const savedColor = localStorage.getItem("eduai-primary-color");
    if (savedColor) {
      // Hàm chuyển đổi Hex sang HSL (tái sử dụng từ AdminDashboard hoặc định nghĩa lại)
      ...
      const hslValue = hexToHSL(savedColor);
